...
exports.result = function(req, res) {
  var user = req.user; 
  var input_brand = req.query.input_brand;
  ...
  if (user) {
    ...
    User.update({'local.email': email_user}, { $push: { 'history': {'brand_original': brand, 'size': size, 'brand_result': output_brand}}}, function(error) {
  ...
  res.render('result', {
    ...
    'shoe_matches_key': shoe_matches_key
  });
};
